...
import com.zeeplive.app.dialog.PictureView1;
...
public class ProfilePagerAdapter extends RecyclerView.Adapter<ProfilePagerAdapter.ViewHolder> {
    ...
    List<com.zeeplive.app.response.UserListResponseNew.FemaleImage> list;
    Context context;
    boolean canOpen;

    public ProfilePagerAdapter(Context context, List<com.zeeplive.app.response.UserListResponseNew.FemaleImage> list, boolean canOpen) {
