...
public class CoinPlansAdapterMyaccount extends RecyclerView.Adapter<CoinPlansAdapterMyaccount.myViewHolder> {
    ...
    public CoinPlansAdapterMyaccount(Context context, List<RechargePlanResponse.Data> list, String type) {
