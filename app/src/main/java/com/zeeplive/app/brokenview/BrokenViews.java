...
public class BrokenViews extends View {
    ...
    public BrokenViews(Context context) {
        this(context, null);
    }

    public BrokenViews(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BrokenViews(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static BrokenViews add2Window(Activity activity) {
        ViewGroup rootView = (ViewGroup) activity.findViewById(Window.ID_ANDROID_CONTENT);
        BrokenViews brokenViews = new BrokenViews(activity);
        rootView.addView(brokenViews, new ViewGroup.LayoutParams(
