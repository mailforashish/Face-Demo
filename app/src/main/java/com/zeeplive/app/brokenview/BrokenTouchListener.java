...
import com.zeeplive.app.brokenview.BrokenAnimator;
import com.zeeplive.app.brokenview.BrokenConfig;

public class BrokenTouchListener implements View.OnTouchListener  {

    private BrokenAnimator brokenAnim;
    private BrokenViews brokenView;
    ...
    public static class Builder {
        private BrokenConfig config;
        private BrokenViews brokenView;
        public Builder(BrokenViews brokenView) {
