...
public class LiveRoomSettingActionSheet extends AbstractActionSheet implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        if (seekBar == mBitrateSeekBar) {
            ...
            if (progress < SessionManager.VIDEO_MIN_BITRATE) {
                progress = SessionManager.VIDEO_MIN_BITRATE;
            }
    ...
    private void gotoMainPage() {
        ...
        mBitrateSeekBar.setMax(SessionManager.VIDEO_MAX_BITRATE);
    ...
    private void setMainPageText() {
        ...
        mMainFrameRateText.setText(SessionManager.FRAME_RATES_TEXT[
    ...
    private String getResolutionText() {
        ...
        switch (mLiveType) {
            case Config.LIVE_TYPE_SINGLE_HOST:
                if (0 <= savedIndex && savedIndex < SessionManager.RESOLUTIONS_SINGLE_HOST_TEXT.length)
                return SessionManager.RESOLUTIONS_SINGLE_HOST_TEXT[application().config().resolutionIndex()];
            default: return null;
        }
    }
    ...
    private class ResolutionAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            switch (mLiveType) {
                case Config.LIVE_TYPE_SINGLE_HOST:
                    resolutionHolder.textView.setText(SessionManager.RESOLUTIONS_SINGLE_HOST_TEXT[position]);
                    break;
                default: break;
            }
        ...
        public int getItemCount() {
            switch (mLiveType) {
                case Config.LIVE_TYPE_SINGLE_HOST:
                    return SessionManager.RESOLUTIONS_SINGLE_HOST.length;
                default: return 0;
            }
        }
    }
    ...
    private class FrameRateAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            frameRateHolder.textView.setText(SessionManager.FRAME_RATES_TEXT[position]);
        ...
        @Override
        public int getItemCount() {
            return SessionManager.FRAME_RATES_TEXT.length;
        }
    }
    ...
    private class LineDecorator extends RecyclerView.ItemDecoration {
        ...
        public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
            ...
            paint.setColor(SessionManager.DIVIDER_COLOR);
